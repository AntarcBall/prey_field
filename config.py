...
AGENT_SPEED_PIXELS_PER_SEC = 65.0
...
FOX_REPLICATION_SIGMA = 6.5
# The possible outcomes for the number of new foxes (e.g., 0 to 8).
FOX_REPLICATION_RANGE = np.arange(0, 4)
